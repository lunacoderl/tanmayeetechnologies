      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-bold uppercase tracking-wider">Total Buyer Sessions</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-bold uppercase tracking-wider">Engagement Events</span>
            <BarChart3 className="w-4 h-4 text-blue-600" />
          </div>
          <div className="text-2xl font-display font-black text-slate-900">
            {dashboardData?.total_events?.toLocaleString() || '8,900'}
          </div>
          <div className="text-[11px] text-slate-500">Catalog searches & spec reads</div>
        </div>

        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-bold uppercase tracking-wider">High Intent Leads</span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            <span className="text-xs font-bold uppercase tracking-wider">Quotation Conversion</span>
          ...
          <div className="text-[11px] text-slate-500">
            {dashboardData?.conversions || 36} purchase quotes converted
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
            ...
            <div className="text-[10px] text-slate-400">100% top of funnel</div>
          </div>
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
            ...
            <div className="text-[10px] text-slate-400">22.8% spec search rate</div>
          </div>
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
            ...
            <div className="text-lg font-black text-brand-600 font-mono">
              {dashboardData?.events_breakdown?.ADD_TO_CART || 680}
            </div>
            <div className="text-[10px] text-slate-400">12.5% intent rate</div>
          </div>

          <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
            <div className="text-xs font-bold text-slate-500 flex items-center gap-1.5">
              <FileCheck className="w-3.5 h-3.5 text-emerald-600" /> Quotes Generated
            </div>
            <div className="text-lg font-black text-emerald-600 font-mono">
              {dashboardData?.events_breakdown?.QUOTE_SUBMITTED || 180}
            </div>
            <div className="text-[10px] text-emerald-600 font-semibold">26.4% cart-to-quote conversion</div>
          </div>
        </div>
      </div>
        ...
        <div className="border border-slate-200 rounded-xl overflow-hidden">
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50 border-b border-slate-200 text-slate-500 font-semibold">
              <tr>
                <th className="p-3">Buyer / Session</th>
                <th className="p-3 text-center">Intent Score</th>
                <th className="p-3 text-right">Cart Value</th>
                <th className="p-3">Primary Equipment Target</th>
